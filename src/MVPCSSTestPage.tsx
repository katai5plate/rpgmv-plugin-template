const MVPCSSTestPage: React.FC = () => (
  <div>
    <header>
      ...
      <h1>
        Page Heading with <i>Italics</i> and <u>Underline</u>
      </h1>
      <p>
      ...
      <p>
        <a href="#">
          <i>Italic Link Button</i>
        </a>
        <a href="#">
          <b>Bold Link Button &rarr;</b>
        </a>
      </p>
    </header>
    <main>
      ...
      <div>
        ...
        <pre>
          <code>// preformatted code block</code>
        </pre>
      </div>
      <hr />
      <section>
